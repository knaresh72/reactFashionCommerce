        ...
        <div className='topnavrow row'>
          ...
          */}
          <div className='cart-wishlist'>
           ...
           <li className="list-icon jsmsahhj" > <Link to="/cart"> <FontAwesomeIcon icon="fa fa-shopping-cart" style={{color:"white"}}/>{cartItemCount>0 && <div className='cart-item-count'><p>{cartItemCount}</p></div>}</Link> </li>
